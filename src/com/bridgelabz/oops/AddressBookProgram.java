...
public class AddressBookProgram {
	...
	public static void main(String[] args) throws JsonParseException, JsonMappingException, IOException {
		...
		CustomizedLinkedList<AddressBook> addressBookList = new CustomizedLinkedList<AddressBook>();
		CustomizedLinkedList<DL> dlList = new CustomizedLinkedList<DL>();
		CustomizedLinkedList<GJ> gjList = new CustomizedLinkedList<GJ>();
		...
		mhList.addAll(addressBookList.get(3).getMh());
